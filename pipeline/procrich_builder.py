...
META_MAP = {
    ...
    "Cont. Locação — NIDO":        "≤24h úteis",
    "Cont. Locação — Confecção":   "≤2h úteis",
    # Rescisão Loc.
    "Rescisão Loc. — Boleto prop": "≤48h da entrega das chaves",
    "Rescisão Loc. — Boleto final":"≤15d corrido",
    "Rescisão Loc. — Levant. Taxas Prop":  "≤2h úteis",
    "Rescisão Loc. — Levant. Taxas Final": "≤2h úteis",
    # Reparos
    ...
    "BackOffice — Concluído":      "≤24h úteis",
